...
function __yq_perform_completion
    ...
    #
    # Patch(Techcable): Incorrect quoting causes fish to interpret jq syntax as command substitutions `(...)` and pipes `|`
    # See: <https://github.com/mikefarah/yq/issues/1502> and <https://github.com/spf13/cobra/issues/1933>
